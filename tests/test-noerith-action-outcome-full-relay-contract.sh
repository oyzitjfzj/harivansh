...
grep -Fq 'cd "$GITHUB_WORKSPACE"' scripts/run-noerith-action-outcome-full.sh
grep -Fq 'bash scripts/run-noerith-verification.sh' scripts/run-noerith-action-outcome-full.sh
